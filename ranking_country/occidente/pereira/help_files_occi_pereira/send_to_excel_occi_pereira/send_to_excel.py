...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\occidente\pereira\help_files_occi_pereira\data_occi_pereira\clusterpereira_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\occidente\pereira\help_files_occi_pereira\data_occi_pereira\clusterpereira_"+str(now)+".xlsx"
