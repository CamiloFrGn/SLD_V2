...
def clean_data(get_clients_df,volumen_attribute_df,cancelations_attribute_df,profits_attribute_df,
               fidelity_integrated_attribute_df,payment_discipline_attribute_df,tools_adoption_attribute_df,cluster,plant):
    try:
        ...
        #merge payment_discipline_attribute_df
        df = pd.merge(df,payment_discipline_attribute_df,on="Cliente",how="left")
        #merge tools_adoption_attribute_df
