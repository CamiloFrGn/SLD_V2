...
data_dir = os.path.join(current_dir, 'panama\lineatres')
print(data_dir)
#our own py scripts
#insert path to get help files 
sys.path.insert(0, data_dir)
from help_files_lineatres.sql_lineatres.connect_sql_server import *
from help_files_lineatres.clean_data_lineatres.clean_data import clean_data
from help_files_lineatres.send_to_excel_lineatres.send_to_excel import send_to_excel
from help_files_lineatres.functions_lineatres.functions import *


#run program
try:
    def main_lineatres(plant):
