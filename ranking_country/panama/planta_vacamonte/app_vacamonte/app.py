...
data_dir = os.path.join(current_dir, 'panama\planta_vacamonte')
print(data_dir)
#our own py scripts
#insert path to get help files 
sys.path.insert(0, data_dir)
from help_files_vacamonte.sql_vacamonte.connect_sql_server import *
...
try:
    def main_vacamonte(plant):
        ...
        plant = 'PA-PLANTA VACAMONTE'
        cluster = 'Panama Oeste'
