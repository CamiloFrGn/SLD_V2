...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\sumapaz\help_files_suro_sumapaz\data_suro_sumapaz\clusterSumapaz_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\sumapaz\help_files_suro_sumapaz\data_suro_sumapaz\clusterSumapaz_"+str(now)+".xlsx"
