...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\ibague\help_files_suro_ibague\data_suro_ibague\clusteribague_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\ibague\help_files_suro_ibague\data_suro_ibague\clusteribague_"+str(now)+".xlsx"
