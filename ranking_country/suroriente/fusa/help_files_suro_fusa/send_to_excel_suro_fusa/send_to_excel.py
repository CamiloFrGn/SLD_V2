...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\fusa\help_files_suro_fusa\data_suro_fusa\clusterfusa_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\fusa\help_files_suro_fusa\data_suro_fusa\clusterfusa_"+str(now)+".xlsx"
