...
def send_to_excel(df):
    try:
        ...
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\metropolitana\help_files_metropo\data_metropo\clustermetropolitana_"+str(now)+".xlsx"
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\metropolitana\help_files_metropo\data_metropo\clustermetropolitana_"+str(now)+".xlsx"
