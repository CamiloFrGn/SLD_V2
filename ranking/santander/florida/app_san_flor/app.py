...
#sys.path.insert(0, r'C:\Users\snortiz\Documents\projects\sld\ranking\santander\florida')
sys.path.insert(0, r'C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\santander\florida')
from help_files_san_flor.sql_san_flor.connect_sql_server import query_sql_df
from help_files_san_flor.clean_data_san_flor.clean_data import clean_data
from help_files_san_flor.send_to_excel_san_flor.send_to_excel import send_to_excel
from help_files_san_flor.functions_san_flor.functions import *


#run program
try:
    def main_florida(plant):
