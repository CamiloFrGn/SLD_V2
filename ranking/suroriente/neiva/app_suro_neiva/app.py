...
#sys.path.insert(0, r'C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\neiva')
sys.path.insert(0, r'C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\neiva')
from help_files_suro_neiva.sql_suro_neiva.connect_sql_server import query_sql_df
from help_files_suro_neiva.clean_data_suro_neiva.clean_data import clean_data
from help_files_suro_neiva.send_to_excel_suro_neiva.send_to_excel import send_to_excel
from help_files_suro_neiva.functions_suro_neiva.functions import *


#run program
try:
    def main_neiva(plant):
