...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\neiva\help_files_suro_neiva\data_suro_neiva\clusterNeiva_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\neiva\help_files_suro_neiva\data_suro_neiva\clusterNeiva_"+str(now)+".xlsx"
