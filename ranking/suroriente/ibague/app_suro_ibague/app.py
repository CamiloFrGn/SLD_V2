...
#sys.path.insert(0, r'C:\Users\snortiz\Documents\projects\sld\ranking\suroriente\ibague')
sys.path.insert(0, r'C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\suroriente\ibague')
from help_files_suro_ibague.sql_suro_ibague.connect_sql_server import query_sql_df
from help_files_suro_ibague.clean_data_suro_ibague.clean_data import clean_data
from help_files_suro_ibague.send_to_excel_suro_ibague.send_to_excel import send_to_excel
from help_files_suro_ibague.functions_suro_ibague.functions import *


#run program
try:
    def main_ibague(plant):
