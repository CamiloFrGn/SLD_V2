...
def send_to_excel(df):
    try:
        ...
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\zona_sur\help_files_zsur\data_zsur\clusterzona_sur_"+str(now)+".xlsx"
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\zona_sur\help_files_zsur\data_zsur\clusterzona_sur_"+str(now)+".xlsx"
        ...
        worksheet.conditional_format('Q2:Q'+str(df_len),
                             {'type': 'text',
                              'criteria': 'containing',
                              'value': 'PLATINUM',
                              'format':   platinum
