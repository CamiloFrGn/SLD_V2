...
def send_to_excel(df):
    try:
        ...
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\santo_domingo\help_files_santodom\data_santodom\clustersanto_domingo_"+str(now)+".xlsx"
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\santo_domingo\help_files_santodom\data_santodom\clustersanto_domingo_"+str(now)+".xlsx"
        ...
        worksheet.conditional_format('O2:O'+str(df_len),
                             {'type': 'text',
                              'criteria': 'containing',
                              'value': 'PLATINUM',
                              'format':   platinum
