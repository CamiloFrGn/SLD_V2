...
#sys.path.insert(0, r'C:\Users\snortiz\Documents\projects\sld\ranking\occidente\pereira')
sys.path.insert(0, r'C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\occidente\pereira')
from help_files_occi_pereira.sql_occi_pereira.connect_sql_server import query_sql_df
from help_files_occi_pereira.clean_data_occi_pereira.clean_data import clean_data
from help_files_occi_pereira.send_to_excel_occi_pereira.send_to_excel import send_to_excel
from help_files_occi_pereira.functions_occi_pereira.functions import *


#run program
try:
    def main_pereira(plant):
