...
def send_to_excel(df):
    try:
        ...
        #path = r"C:\Users\snortiz\Documents\projects\sld\ranking\occidente\cali\help_files_occi_cali\data_occi_cali\clustercali_"+str(now)+".xlsx"
        path = r"C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\occidente\cali\help_files_occi_cali\data_occi_cali\clustercali_"+str(now)+".xlsx"
