...
sys.path.insert(0, r'C:\Users\jsdelgadoc\Documents\Proyectos-Cemex\sld_v2\ranking\panama\vacamonte')
from help_files_vacamonte.sql_vacamonte.connect_sql_server import query_sql_df
from help_files_vacamonte.clean_data_vacamonte.clean_data import clean_data
from help_files_vacamonte.send_to_excel_vacamonte.send_to_excel import send_to_excel
from help_files_vacamonte.functions_vacamonte.functions import *


#run program
try:
    def main_vacamonte(plant):
